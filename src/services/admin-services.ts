...
export const updateCourse = async (route: string, payload: any) => {
    const axiosInstance = await getAxiosInstance()
    return axiosInstance.put(route, payload)
}
...
export const getSingleCourse = async (route: string) => {
    const axiosInstance = await getAxiosInstance()
    return axiosInstance.get(route)
}
...
export const deleteAudiobookChapters = async (route: string,) => {  //-----Book school tab
    const axiosInstance = await getAxiosInstance()
    return axiosInstance.delete(route)
}
...
export const deleteBook = async (route: string) => {
    const axiosInstance = await getAxiosInstance()
    return axiosInstance.delete(route)
}

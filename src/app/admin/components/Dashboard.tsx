...
const [usersDuration, setUsersDuration] = useState();

const handleSelectChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    const selectedValue = e.target.value;
    setOverviewDuration(selectedValue);
    //onOverviewDurationChange(selectedValue); // Notify parent of the change
  };
    return (
        <div>
            ...
            <div>
                <select name="overviewDuration" value={overviewDuration} className="py-[9px] px-[14px] rounded-[17px] ">
           ...
           <div className='flex justify-between items-center pb-2'>
            ...
            <div>
                <select name="usersDuration" value={usersDuration} className="py-[9px] px-[14px] rounded-[17px] ">
                <option value="7">Last 7 days</option>
                <option value="30">Last 30 days</option>
                </select>
            </div>

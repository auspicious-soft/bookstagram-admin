...
import { AudioBookIcon, EBookIcon } from './../../../utils/svgicons';
...
const BookCard: React.FC<CardProps> = ({ title, author, price, imgSrc, discount, handleDelete, handleClick, file, format }) => {

...
const GenerateVoucher: React.FC<ModalProp> = ({ open, onClose, mutate }) => {
    ...
    const [activationAllowed, setActivationAllowed] = useState('');
    ...
    return (
        ...
        >
            <div className='modal bg-white py-[30px] px-5 max-w-[617px] mx-auto rounded-[20px] w-full h-fit'>
                    ...
                    <div className='main-form '>
                        <div className="flex gap-[20px]">
                            ...
                            <label className="w-full">
                                ...
                                <input
                                    type="number"
                                    name='allowedActivation'
                                    value={activationAllowed}
                                    onChange={(e) => setActivationAllowed(e.target.value)}
                                    placeholder='1'
                                    required
                                    min="1" />
                            </label>
                        ...
                        <div className='mt-[30px] flex gap-2.5 justify-end'>
                            <button
                                ...
                                disabled={isPending || !percentage || !activationAllowed}
                            >

...
// //   const { data, mutate } = useSWR(`/admin/stories/${id}`, getSingleStory);
// //   const [isPending, startTransition] = useTransition();
// //   const [files, setFiles] = useState<Record<string, { link: string; type: string }>>({});
// //   const [storyModal, setStoryModal] = useState(false);
...
// //     const newFiles: Record<string, { link: string; type: string }> = { ...files };

// //     Array.from(e.target.files).forEach((file) => {
// //       const type = file.type.startsWith('video') ? 'video' : 'image';
// //       const url = URL.createObjectURL(file);
// //       newFiles[file.name] = { link: url, type };
// //     });
...
// //         const payload = {
// //           name: storyData.name,
// //           file: files, // now contains type and link
// //         };
// //         const response = await updateStory(`/admin/stories/${id}`, payload);
...
// //           className="bg-orange text-white text-sm px-5 py-2.5 rounded-[28px]"
// //         >
// //           Edit Story
// //         </button>
// //       </div>
...
// //       <EditStoryModal onClose={() => setStoryModal(false)} open={storyModal} data={storyData} />
// //     </div>
// //   );
// // };
